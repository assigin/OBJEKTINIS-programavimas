...
void ivedimas(studentas& temp)
{
        ...
        while (a == 1)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < temp.darbu_sk; i++)
                {
                    ...
                    temp.suma = temp.suma + temp.pazymiai[i];
                }
                break;
            }
        }
    ...
    {
        int paz, i = 0, sk = 0;
        cout << "Iveskite kiek pazymiu studentas turi: " << endl;
        cin >> sk;
        temp.pazymiai = new int[sk];
        cout << "Iveskite pazymius, o baige juos ivest, iveskite bet kokia raide: " << endl;;
        while (cin >> paz)
        {
            if (paz > 1 || paz < 10)
            {
